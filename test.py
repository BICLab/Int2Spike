...
lif1.visualize_spike(filename="Binary_Lif_T15_N20.png", title=f"BinaryLif(Tokens=20 TimeStep={spike1.shape[0]} FiringRate={rate1:.2f})")
...
lif2.visualize_spike(filename="Ternary_Lif_T8_N20.png", title=f"Ternary_Lif(Tokens=20 TimeStep={spike2.shape[0]} FiringRate={rate2:.2f})")
...
lif3.visualize_spike(filename="Bitwise_Lif_T4_N20.png", title=f"Bitwise_Lif(Tokens=20 TimeStep={spike3.shape[0]} FiringRate={rate3:.2f})")
...
lif4.visualize_spike(filename="Bitwise_Lif_T4_N20_bidirectional.png", title=f"Bitwise_Lif(Tokens=20 TimeStep={spike4.shape[0]} FiringRate={rate4:.2f} Bidirectional)")
...
lif5.visualize_spike(filename="Bitwise_Lif_T4_N20_complement.png", title=f"Bitwise_Lif(Tokens=20 TimeStep={spike5.shape[0]} FiringRate={rate5:.2f} Complement)")
